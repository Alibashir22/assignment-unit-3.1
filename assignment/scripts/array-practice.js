...
let favoriteFoods = ['pizza', 'wings', 'rice,' ];
console.log('My favorie foods are:', favoriteFoods)
...
console.log('secound animal is',secondAnimal);
...
console.log('Add an entree to the beginnig: {favoriteFoods}');
